                ...
                @foreach ($blogs as $key => $blog)
                    <div class="col-md-4 ftco-animate">
                        <div class="blog-entry">
                            ...
                            style="background-image: url('{{ $key % 2 == 0 ? asset('images/pregnant_background.jpg') : asset('images/pregnant_background2.jpg') }}');">
                            ...
                            <div class="text bg-white p-4">
                                <h3 class="heading"><a href="/blogs/single/{{ $blog->id }}">{{ $blog->title }}</p>
                                        <div class="d-flex align-items-center mt-4">
                                            <p class="mb-0"><a href="/blogs/single/{{ $blog->id }}" class="btn btn-primary">Read More <span
