    ...
    <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
            <div class="col-md-9 ftco-animate text-center">
                ...
                <p class="breadcrumbs"><span class="mr-2"><a href="/">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Questions <i class="ion-ios-arrow-forward"></i></span></p>
            </div>
        </div>
    </div>
</section>
                        ...
                        @if ($i >= $questions->currentPage() - 2 && $i <= $questions->currentPage() + 2)
                            ...
                            @if ($questions->currentPage() < $questions->lastPage() - 3)
                                ...
                                @if ($questions->currentPage() < $questions->lastPage() - 2)
                                    <li class="hidden-xs"><a href="{{ $questions->url($questions->lastPage()) }}">{{ $questions->lastPage() }}</a>
                                    </li>
                                    @endif
